...
const string strMessageMagic = "Loco Signed Message:\n";
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 2000;  // 100,000% yearly interest 
    }
    else if(pindexBest->nHeight < 10000)
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 1500;  // 75,000% yearly interest 
    }
    else if(pindexBest->nHeight < 12500)
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 1000;  // 50,000% yearly interest 
    }
    else if(pindexBest->nHeight < 15000)
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 500;  // 25,000% yearly interest 
    }
    else if(pindexBest->nHeight < 17500)
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 200;  // 10,000% yearly interest 
    }
    else if(pindexBest->nHeight < 20000)
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 100;  // 5,000% yearly interest 
    }
    else if(pindexBest->nHeight < 22500)
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 50;  // 2,500% yearly interest 
    }
    else if(pindexBest->nHeight < 25000)
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 20;  // 1,000% yearly interest 
    }
    else if(pindexBest->nHeight < 30000)
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 10;  // 500% yearly interest 
    }
    else if(pindexBest->nHeight < 60000)
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 5;  // 250% yearly interest 
    }
    else if(pindexBest->nHeight < 120000)
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 2;  // 100% yearly interest 
    }
...
static int64_t nTargetTimespan = 12 * 60;  // 12 mins
