...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Loco
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Loco
    // Mac: ~/Library/Application Support/Loco
    // Unix: ~/.loco
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Loco";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "loco.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "locod.pid"));
